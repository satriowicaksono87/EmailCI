...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'satriowicaksono076@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Satrio Putro Wicaksono'; // Isikan dengan nama pengirim
    protected $password = 'gedhekcz82/'; // Isikan dengan password email pengirim
